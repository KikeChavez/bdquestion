    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h5 class="card-title"> <strong>Preguntas activas</strong> </h5>
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <td><b>Numero de pregunta</b></td>
                                <td><b>Pregunta</b></td>
                                <td></td>
                                <td></td>
                                <td></td>
                        ...
                        <tbody>
                            <?php while ($row = $preguntas->fetch_assoc()) { ?> 
                                <tr>
                                    ...
                                    <td>
                                        <a href="../vistas/confrespuestas.php?id=<?php echo $row['id']; ?>">Respuestas</a>
                                    </td>
                                    <td>
                                        <a href="../vistas/editquestion.php?id=<?php echo $row['id']; ?>">Editar</a>
                                    </td>
                                    <td>
                                        <a href="../includes/deletequestion.php?id=<?php echo $row['id']; ?>">Eliminar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Agregar una nueva pregunta</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form method="POST" action="../includes/addpregunta.php">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Pregunta</label>
                                <input type="text" class="form-control" name="pregunta" placeholder="Ingrese informacón" required>
                            </div>
